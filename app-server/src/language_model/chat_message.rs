...
#[derive(Deserialize)]
#[serde(untagged)]
pub enum OtelChatMessageImageUrl {
...
pub enum OtelChatMessageContentPart {
    ...
    Text(ChatMessageText),
    #[serde(rename = "image_url")]
    ImageUrl(OtelChatMessageImageUrl),
    #[serde(rename = "image")]
...
impl Into<ChatMessageContentPart> for OtelChatMessageContentPart {
    fn into(self) -> ChatMessageContentPart {
        match self {
            ...
            OtelChatMessageContentPart::ImageUrl(image_url) => match image_url {
                OtelChatMessageImageUrl::OpenAIImageUrl(image_url) => {
