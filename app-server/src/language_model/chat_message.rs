...
#[derive(Deserialize)]
#[serde(untagged)]
pub enum InstrumentationImageUrl {
    // TODO: Add support for other providers
    OpenAIImageUrl(OpenAIImageUrl),
}

/// Struct to decode any kind of chat message content part from automatic instrumentation by Traceloop
///
...
pub enum InstrumentationChatMessageContentPart {
    ...
    Text(ChatMessageText),
    #[serde(rename = "image_url")]
    ImageUrl(InstrumentationImageUrl),
    #[serde(rename = "image")]
    Image(InstrumentationChatMessageImage),
}

impl Into<ChatMessageContentPart> for InstrumentationChatMessageContentPart {
    fn into(self) -> ChatMessageContentPart {
        match self {
            ...
            InstrumentationChatMessageContentPart::ImageUrl(image_url) => match image_url {
                InstrumentationImageUrl::OpenAIImageUrl(image_url) => {
