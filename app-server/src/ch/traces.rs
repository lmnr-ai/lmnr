...
impl CHTrace {
    ...
    pub fn from_db_trace(trace: &Trace) -> Self {
        ...
        CHTrace {
            ...
            cache_read_input_tokens: Some(trace.cache_read_input_tokens()),
            cache_creation_input_tokens: Some(trace.cache_creation_input_tokens()),
            reasoning_tokens: Some(trace.reasoning_tokens()),
