...
/// `openai` | `openai_responses` | `gemini` | `bedrock` | `azure_openai` |
/// `azure_openai_responses` | `foundry_anthropic` | `mock`. The single provider switch.
pub const PROVIDER: &str = "LLM_PROVIDER";
#[cfg_attr(not(feature = "signals"), allow(dead_code))]
pub const PARSING_PROVIDER: &str = "SIGNALS_PARSING_LLM_PROVIDER";
/// Shared single-provider API key (openai / gemini / azure_openai).
...
/// Either this or [`AZURE_OPENAI_BASE_URL`] is required when `LLM_PROVIDER=azure_openai*`.
pub const AZURE_OPENAI_RESOURCE_ID: &str = "AZURE_OPENAI_RESOURCE_ID";
...
pub const AZURE_OPENAI_BASE_URL: &str = "AZURE_OPENAI_BASE_URL";
...
pub const FOUNDRY_ANTHROPIC_RESOURCE_ID: &str = "FOUNDRY_ANTHROPIC_RESOURCE_ID";
/// Full Foundry endpoint, for private endpoints / gateways. Takes precedence
/// over the resource id.
pub const FOUNDRY_ANTHROPIC_BASE_URL: &str = "FOUNDRY_ANTHROPIC_BASE_URL";
