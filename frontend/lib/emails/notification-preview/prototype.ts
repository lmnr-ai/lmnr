...
function action(t: NotificationEmailTheme, label: string, align: "left" | "center" = "center"): string {
  return `<div style="margin-top:20px;text-align:${align};"><a href="${ACTION}" style="display:inline-block;background:#d57e57;color:${t.pageBackground};text-decoration:none;padding:10px 16px;border-radius:4px;font-size:${t.bodySize}px;font-weight:400;">${escapeHtml(label)}</a></div>`;
}
