...
This Cookie Policy explains how LMNR AI, Inc. (DBA Laminar) ("**Company**," "**we**," "**us**," and "**our**") uses cookies and similar technologies to recognize you when you visit our website at [https://laminar.sh](https://laminar.sh) ("**Website**"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.
...
|             |                              |
| ----------- | ---------------------------- |
| Name:       | \_\_Secure-better-auth.state |
| Purpose:    | Authentication               |
| Provider:   | LMNR AI, Inc. (DBA Laminar)  |
| Type:       | http_cookie                  |
| Expires in: | 30 days                      |

|             |                             |
| ----------- | --------------------------- |
| Name:       | evaluation-trace-view-width |
| Purpose:    | Store viewing functionality |
| Provider:   | LMNR AI, Inc. (DBA Laminar) |
| Type:       | http_cookie                 |
| Expires in: | 30 days                     |
...
|             |                             |
| ----------- | --------------------------- |
| Name:       | traces-trace-view-width     |
| Purpose:    | Store view configuration    |
| Provider:   | LMNR AI, Inc. (DBA Laminar) |
| Type:       | http_cookie                 |
| Expires in: | 30 days                     |
...
|             |                                      |
| ----------- | ------------------------------------ |
| Name:       | \_\_Secure-better-auth.session_token |
| Purpose:    | Authentication                       |
| Provider:   | LMNR AI, Inc. (DBA Laminar)          |
| Type:       | http_cookie                          |
| Expires in: | 30 days                              |
...
If you have any questions about our use of cookies or other technologies, please contact us at:founders@lmnr.ai
