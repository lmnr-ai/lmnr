-- LAM-1578 follow-up: rename `spans.span_type` (the underlying UInt8 column)
-- to `spans.span_kind`. The `spans_v0` view still exposes the multiIf
-- projection aliased back to `span_type` so external queries are unaffected.
--
