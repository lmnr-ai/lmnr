...
ALTER TABLE signal_event_clusters ADD COLUMN IF NOT EXISTS centroid_at_naming Array(BFloat16) DEFAULT centroid CODEC(NONE);
ALTER TABLE signal_event_clusters ADD CONSTRAINT IF NOT EXISTS signal_event_clusters_centroid_at_naming_dim_768 CHECK length(centroid_at_naming) = 768;
