-- `evaluations.group_id` (Postgres) is the single source of truth for group
-- membership; datapoints resolve their group through `evaluation_id`.
...
ALTER TABLE evaluation_datapoints DROP COLUMN IF EXISTS group_id;
