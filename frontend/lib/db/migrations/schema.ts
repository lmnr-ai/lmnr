...
export const tagClasses = pgTable(
  ...
  (table) => [
    uniqueIndex("tag_classes_project_id_id_key").using(
      "btree",
...
export const tags = pgTable(
  ...
  (table) => [
    uniqueIndex("tags_span_id_class_id_user_id_key").using(
      "btree",
      table.classId.asc().nullsLast().op("uuid_ops"),
      table.spanId.asc().nullsLast().op("uuid_ops"),
      table.userId.asc().nullsLast().op("uuid_ops")
    ),
    unique("tags_span_id_class_id_unique").on(table.classId, table.spanId),
    unique("tags_span_id_class_id_user_id_unique").on(table.classId, table.spanId, table.userId),
  ]
);
