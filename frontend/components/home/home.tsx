...
import { HomeTraceProvider, useHomeTraceStore } from "@/components/home/home-trace-context";
import AddChartDropdown from "@/components/home/add-chart-dropdown";
...
function HomeContent() {
  ...
  const { traceId, spanId, closeTrace } = useHomeTraceStore((s) => ({
    traceId: s.traceId,
    spanId: s.spanId,
