  ...
  return (
    <div className="p-4 flex flex-col space-y-2">
      ...
      <div className="flex items-center w-full justify-between">
        <Label className="mr-2 text-secondary-foreground">
          Supply model name as an input
        </Label>
        <Switch
        ...
        <>
          ...
          {isPromptDisabled && (
            <Label className="text-sm text-secondary-foreground">
              OpenAI o1 models are in preview. System prompt will be converted
      ...
      {data.model == undefined && (
        <div className="space-y-2 py-2 flex flex-col">
          <Label className="text-secondary-foreground">
            Supply the model as an input to this node in the{' '}
            <code>provider:model-id</code> format.
          </Label>
          <Label className="text-secondary-foreground">
      ...
      {data.modelParams !== null && (
        <Ide
          ...
          mode={'json'}
          value={
            typeof data.modelParams === 'string'
              ? data.modelParams
      ...
      <div className="flex items-center w-full justify-between pt-2 border-t">
        ...
        <Switch
          disabled={!editable}
          checked={data.inputs.some(
            (input) =>
              input.name === 'chat_messages' &&
