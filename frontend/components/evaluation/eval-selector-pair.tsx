...
// Breadcrumb-styled trigger: no border / background, inherits font, just a small caret.
const TRIGGER_CLASS =
  "h-auto w-auto border-none bg-transparent px-2 py-0 text-sm gap-1 [&>svg]:opacity-50 [&>svg]:size-3";
