...
// Global so the drawer width persists across refreshes and between evaluations.
...
export default function EvalTraceLayout({ table, traceColumn }: EvalTraceLayoutProps) {
  ...
  // Lazy-read the persisted width. Safe from hydration mismatch: the first paint
  // always has maxWidth=0, which clamps to MIN_TABLE regardless of this value.
