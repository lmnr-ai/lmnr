...
import { dataPreview } from "@/components/evaluation/poc/sidebar-row";
...
export function LabelCell({ row }: CellContext<EvalRow, unknown>) {
  ...
  return (
    <span className="flex min-w-0 items-center gap-1.5">
      ...
      <span className="shrink-0 text-xs font-medium tabular-nums text-secondary-foreground">#{index ?? "?"}</span>
