...
export interface CreateSignalJobTableContentsProps {
  filter: string[];
  search: string | null;
...
export const CreateSignalJobTableContents = memo(function CreateSignalJobTableContents({
  children,
  filter,
  search,
  dateRange,
  ...
  onOpenConfirmDialog,
  onTraceIdSelect,
}: PropsWithChildren<CreateSignalJobTableContentsProps>) {
