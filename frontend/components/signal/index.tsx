  ...
  return (
    <>
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="flex-1 flex flex-col gap-4 overflow-hidden">
        ...
        {!isFreeTier && (
          <TabsContent value="settings" className="flex flex-col overflow-hidden items-center">
            <ManageSignalPanel key={signal.id} defaultValues={signal} onSuccess={handleSuccess} className="" />
          </TabsContent>
        )}
      </Tabs>
