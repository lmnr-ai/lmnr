...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-[13px] leading-none font-medium transition-colors disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary/90 text-primary-foreground hover:bg-primary border border-white/15",
        ...
        warningOutline: "border border-warning/50 text-warning shadow-sm hover:bg-warning/10",
        outline: "border border-input bg-background hover:bg-accent",
        outlinePrimary: "border border-primary/60 bg-background hover:bg-primary/10 text-primary",
        secondary: "bg-secondary text-secondary-foreground hover:bg-accent border border-border/60",
