...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-[13px] leading-none font-medium transition-colors duration-150 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary/90 text-primary-foreground hover:bg-primary border border-white/10",
        destructive: "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90",
        destructiveOutline:
          "border border-destructive/60 text-destructive shadow-sm hover:bg-destructive/10 hover:text-destructive",
        warning: "bg-amber-700/80 text-amber-50 shadow-sm hover:bg-amber-700",
        warningOutline: "border border-amber-600/40 text-amber-500 shadow-sm hover:bg-amber-500/10",
        ...
        secondaryLight: "bg-secondary text-secondary-foreground hover:bg-accent",
      ...
      size: {
        ...
        lg: "h-9 rounded-md px-6 text-[13px]",
        icon: "h-7 w-7",
      },
    },
    defaultVariants: {
