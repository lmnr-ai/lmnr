...
export const ColumnsMenuItem = ({
  ...
  return (
    <div
      style={style}
      className={cn(
        "relative flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-xs transition-colors hover:bg-[var(--surface-raise)] hover:text-accent-foreground w-full",
        isLocked && "hidden"
      )}
    >
      <div
