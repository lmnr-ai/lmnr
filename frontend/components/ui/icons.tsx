...
function IconBrowserUse({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
