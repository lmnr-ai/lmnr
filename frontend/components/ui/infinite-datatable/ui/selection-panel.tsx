...
export function SelectionPanel({ selectedRowIds, onClearSelection, selectionPanel }: SelectionPanelProps) {
  ...
  return (
    <div className="h-12 flex pl-4 pr-3 items-center border-primary/50 border rounded-lg absolute bottom-4 z-50 left-1/2 transform -translate-x-1/2 bg-surface-400 gap-2">
