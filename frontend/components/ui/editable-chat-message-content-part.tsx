...
export default function EditableChatMessageContentPart({
  defaultPart,
  index,
  onDelete,
  onEdit
}: EditableChatMessageContentPartProps) {
  ...
  const changeType = () => {
    ...
    if (newType === 'text') {
      ...
      newPart = {
        type: 'image',
        mediaType: SUPPORTED_MEDIA_TYPES[0],
        data: ''
      };
    } else {
  ...
  return (
    <div className="flex flex-col pb-2 group">
      <div className="flex items-center mb-2">
        <div className="flex">
          <button
            className="px-1.5 h-5 text-xs bg-secondary rounded"
            onClick={changeType}
          >
            {part.type}
          </button>
      ...
      {part.type === 'text' ? (
        ...
        <div className="flex flex-col space-y-2">
          ...
          <Input
            ...
            onChange={(e) => {
              imageDataChange(e.currentTarget.value);
            }}
            spellCheck={false}
            maxLength={-1}
          />
        ...
        <DefaultTextarea
          ...
          onChange={(e) => {
            imageUrlChange(e.currentTarget.value);
          }}
          spellCheck={false}
          maxLength={-1}
        />
