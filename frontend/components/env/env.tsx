  ...
  return (
    <>
      ...
      <div className="flex flex-col items-start space-y-4 p-4">
        ...
        <Label className="">
          Set your environment variables to use in pipelines. Laminar never
          stores your environment variables, they are only saved in your
          browser.
        </Label>
        <AddEnvVarDialog
          onAdd={(name, value) => {
