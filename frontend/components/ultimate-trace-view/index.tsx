...
import UltimateTraceViewContent from "./ultimate-trace-view-content";
import UltimateTraceViewProvider from "./ultimate-trace-view-provider";

interface UltimateTraceViewProps {
...
export default function UltimateTraceView({ trace, seeds, headerPath, sessionId }: UltimateTraceViewProps) {
  ...
  return (
    <UltimateTraceViewProvider seeds={resolvedSeeds} initialTrace={trace}>
      ...
      <UltimateTraceViewContent sessionId={sessionId} sessionTitle={sessionTitle} />
