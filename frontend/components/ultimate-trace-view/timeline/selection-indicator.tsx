...
export default function SelectionIndicator({ selectedCount, onClear }: SelectionIndicatorProps) {
  ...
  return (
    <div className="absolute top-1.5 left-1/2 -translate-x-1/2 z-40 flex items-center gap-1.5 bg-primary text-primary-foreground rounded-md px-2 h-[24px] text-xs">
