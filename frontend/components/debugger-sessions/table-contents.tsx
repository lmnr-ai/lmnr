...
export interface DebuggerSessionsTableContentsProps {
  columns: ColumnDef<DebuggerSession>[];
}

export const DebuggerSessionsTableContents = memo(function DebuggerSessionsTableContents({
  children,
  columns,
}: PropsWithChildren<DebuggerSessionsTableContentsProps>) {
