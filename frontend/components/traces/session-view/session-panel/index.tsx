...
export default function SessionPanel() {
  ...
  return (
    <div className="flex flex-col items-center h-full w-full overflow-hidden flex-1">
      <div className="flex flex-col h-full w-full max-w-[1600px] 2xl:max-w-[1800px] overflow-hidden">
        {/* Header */}
