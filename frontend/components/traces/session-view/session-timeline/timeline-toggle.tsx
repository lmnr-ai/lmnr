// TODO: This component duplicates trace-view/header/timeline-toggle.tsx.
...
interface SessionTimelineToggleProps {
  enabled: boolean;
  setEnabled: (enabled: boolean) => void;
  className?: string;
}

export default function SessionTimelineToggle({ enabled, setEnabled, className }: SessionTimelineToggleProps) {
  return (
    <div
      className={cn(
