...
const SpanNodeRenderer = memo(
  ({
    ...
    const isSelected = selectedBlockSpanId === node.span.spanId;
    ...
    const overlayHeightPx = overlayHeightRows * DIFF_ROW_HEIGHT - 2;
      ...
      <>
        ...
        <div
          ...
          style={{
            left: `${left}%`,
            width: `max(${width}%, 4px)`,
            top: row * DIFF_ROW_HEIGHT + 1,
            height: DIFF_ROW_HEIGHT - 2,
            backgroundColor,
          }}
        ...
        {isCondensed && range && (
          <div
            ...
            style={{
              ...
              top: range.minRow * DIFF_ROW_HEIGHT + 1,
