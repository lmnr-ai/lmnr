...
export default function SpanEventsAddEvent({
  spanId,
  onEventCreate
}: SpanEventsAddEventProps) {
  ...
  return (
    ...
    >
      ...
      <PopoverContent
        side="bottom"
        className="max-h-96 overflow-y-auto ml-72 w-96"
      >
        <div className="flex flex-col space-y-2 items-start p-1">
          ...
          <div className="flex w-full justify-end">
            <Button
              ...
              disabled={
                isLoading ||
                (selectedEventTypeId === null && newEventTypeName === '') ||
                !newEventValue
              }
              handleEnter
            >
