...
import { memo, type ReactNode, type RefObject, useCallback, useEffect, useMemo } from "react";
...
export interface TracesTableGridProps {
  chrome: ReactNode;
...
export const TracesTableGrid = memo(function TracesTableGrid({
  chrome,
  refetchRef,
  columnDefs,
  effectiveColumns,
