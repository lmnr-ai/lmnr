    ...
    >
      ...
      >
        ...
        {message.messageType === "step" && (
          <GitCommitHorizontal className="mt-1 ml-2 mr-2" size={14}/>
        )}
        ...
        {'text' in message.content ? (
          <div data-testid="message-content" className="flex flex-row gap-2 items-start">
            <div
              className={cn("flex flex-col gap-4", {
                "text-primary-foreground px-3 py-2 rounded-l-xl rounded-tr-xl": message.messageType === "user",
              })}
            >
          ...
          <div data-testid="message-content" className="flex flex-row gap-2 items-start">
            <div
              className={cn("flex flex-col gap-4 text-secondary-foreground -mb-2")}
            >
