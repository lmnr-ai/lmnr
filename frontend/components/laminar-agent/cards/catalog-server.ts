...
/**
 * Shared card component definitions used by both server and client catalogs.
 */
export const cardComponentDefs = {
  TraceCard: {
    props: z.object({
...
/**
 * Server-safe catalog using @json-render/core schema only.
 * Safe to import from API routes — does NOT use createContext.
 * Used for prompt generation (agentCatalog.prompt()).
 */
...
export const agentCatalogServer = defineCatalog(serverSchema, {
