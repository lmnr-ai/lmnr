            ...
            {alerts?.map((alert) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    "group relative flex cursor-pointer flex-col gap-3 rounded-lg border bg-surface-200 [--surface-raise:var(--color-surface-400)] [--surface-border:var(--surface-border-2)] px-4.5 py-4",
