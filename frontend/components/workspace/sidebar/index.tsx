...
const WorkspaceSidebar = ({ workspace }: { workspace: WorkspaceWithUsers }) => {
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <SidebarMenuButton className="w-[calc(100%_-_16px)] p-1">
                  <div className="bg-background flex aspect-square size-6 items-center justify-center rounded-lg">
                    <Image className="size-3" alt="Laminar AI logo" src={smallLogo} />
                  </div>
