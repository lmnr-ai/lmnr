...
const EvalsSDKImage = ({ className }: Props) => {
  return (
    <div
      className={cn(
        "bg-landing-surface-700 flex items-start overflow-clip px-10 py-[30px] rounded relative",
        className
      )}
    >
      ...
      <div className="absolute flex h-[151px] items-center justify-center left-0 top-[132px] w-[573px]">
        <div className="rotate-90">
          <div className="bg-gradient-to-l from-landing-surface-700 to-transparent h-[573px] w-[151px]" />
        </div>
      </div>
    </div>
  );
