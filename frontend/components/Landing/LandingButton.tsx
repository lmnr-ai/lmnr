  ...
  ({ className, variant = "minimal", size = "md", children, ...props }, ref) => {
    ...
    const variantStyles = {
      minimal: size === "sm" 
        ...
        : "px-4 py-1 hover:text-landing-text-100",
      outline: size === "sm" 
        ? "border border-landing-text-600 px-4 py-2 hover:text-landing-text-100 hover:border-landing-text-400" 
        : "border border-landing-text-600 px-5 py-3 hover:text-landing-text-100 hover:border-landing-text-400",
      primary: size === "sm" 
        ...
        : "bg-landing-primary-400 text-white px-5 py-3 border border-white/40 hover:bg-landing-primary-300 active:bg-landing-primary-200",
    };
