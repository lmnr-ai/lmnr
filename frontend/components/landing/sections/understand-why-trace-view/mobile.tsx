  ...
  return (
    <section className="w-full flex flex-col gap-16 px-6 py-16">
      ...
      <div className="flex flex-col gap-6 items-start w-full">
        ...
        <div className="bg-surface-250 relative w-full overflow-hidden h-[280px] px-5 py-4 flex flex-col justify-center">
      ...
      <div className="flex flex-col gap-6 items-start w-full">
        ...
        <div className="bg-surface-250 relative w-full overflow-hidden h-[360px]">
          ...
          <div ref={transcriptRef} className="absolute inset-0 flex px-8">
            <div
              className="border-[0.5px] border-surface-300 rounded-lg overflow-hidden shrink-0 mx-auto h-full"
              style={{ width: 480 }}
            >
              <motion.img
            ...
            <div className="absolute top-0 left-0 right-0 h-[40px] bg-gradient-to-b from-surface-250/80 to-transparent pointer-events-none z-10" />
          </div>
          <div className="absolute bottom-0 left-0 right-0 h-[160px] bg-gradient-to-t from-surface-250 to-transparent pointer-events-none z-10" />
      ...
      <div className="flex flex-col gap-6 items-start w-full">
        ...
        <div className="bg-surface-250 relative w-full overflow-hidden h-[360px] flex items-end justify-end px-8 pt-4 pb-12">
          <div
            className="border-[0.5px] border-surface-400 rounded-lg overflow-hidden shrink-0 mx-auto relative origin-bottom-right scale-80"
