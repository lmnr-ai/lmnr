        ...
        <section ref={sectionRef} className={cn("relative w-full mx-auto px-6 lg:px-0", LANDING_COLUMN_MAX_W)}>
          <div className="flex gap-18 2xl:gap-36">
            ...
            <div className="relative min-w-0 h-[240vh] flex-1">
              <div className="sticky top-0 h-screen overflow-hidden flex flex-col justify-center items-center">
                <div className="h-[760px] w-full overflow-hidden relative">
                  ...
                  <div className="absolute top-0 left-0 right-0 z-10 bg-gradient-to-b from-surface-150 to-transparent pointer-events-none h-[100px]" />
                  ...
                  <div className="absolute bottom-0 left-0 right-0 z-10 bg-gradient-to-t from-surface-150 to-transparent pointer-events-none h-[120px]" />
                </div>
              </div>
            </div>
            ...
            {/* RIGHT — see LAYOUT comment above for the outer/inner pattern.
              ...
              fade INTO the rectangle's own bg (`surface-250`)
            ...
            <div className="relative">
              <div className="sticky top-0 left-0 flex justify-center items-center h-screen">
                <div className="w-[480px] h-[760px] rounded-sm bg-surface-250 overflow-hidden flex items-center justify-end px-5 relative">
                  ...
                  {phase === 4 && (
                    <div className="absolute bottom-0 left-0 top-0 z-10 bg-gradient-to-r from-surface-250/80 to-transparent pointer-events-none w-[80px]" />
                  )}

                  {/* Bottom gradient */}
                  <div className="absolute bottom-0 left-0 right-0 z-10 bg-gradient-to-t from-surface-250 to-transparent pointer-events-none h-[120px]" />
