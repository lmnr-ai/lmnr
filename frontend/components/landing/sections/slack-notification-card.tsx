...
export const SlackContent = () => (
  <div className="flex gap-3 items-start w-full px-3 pt-2 pb-3">
    <div className="shrink-0 size-8 bg-surface-100 rounded flex items-center justify-center overflow-hidden">
    ...
    <div className="flex flex-1 flex-col gap-3 items-start min-w-0 overflow-hidden">
      <div className="flex flex-col gap-1 w-full">
        <div className="flex items-center gap-1 w-full whitespace-nowrap font-sans text-xs">
          ...
          <div className="bg-surface-600 rounded px-1 py-0.5 flex items-center justify-center">
        ...
        <div className="flex gap-0.5 items-center font-sans text-xs">
          <div className="bg-muted border border-surface-800 rounded px-1.5 py-px">
      ...
      <div className="flex flex-row gap-2 items-center">
        <div className="bg-surface-600 px-2 py-1 rounded">
