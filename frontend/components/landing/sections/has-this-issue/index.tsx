...
// surface-250 panel with a footnote pinned to the bottom.
const HasThisIssue = () => (
  <section className="flex flex-col gap-10 items-start w-full">
    ...
    <div className="bg-surface-250 relative flex items-center w-full md:py-[120px] py-[70px] overflow-hidden px-8">
