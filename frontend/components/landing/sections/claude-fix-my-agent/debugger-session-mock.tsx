...
// --- Browser chrome ----------------------------------------------------------
const BrowserBar = () => (
  <div className="flex h-8 shrink-0 items-center gap-8 border-b border-surface-300 bg-surface-150 px-3">
    <div className="flex gap-1.5">
      <span className="size-2.5 rounded-full bg-surface-350" />
      <span className="size-2.5 rounded-full bg-surface-350" />
      <span className="size-2.5 rounded-full bg-surface-350" />
    </div>
    <span className="mx-auto flex-1 rounded-sm bg-surface-250 py-0.5 text-center text-[11px] font-medium text-foreground-500">
...
const DebuggerSessionMock = ({ name, traces, revealKey, onToggle, className }: Props) => {
  ...
  return (
    <div
      className={cn(
        "flex h-[480px] w-[400px] shrink-0 flex-col overflow-hidden rounded-md border border-surface-300 bg-surface-100",
        className
      )}
    >
      <BrowserBar />
