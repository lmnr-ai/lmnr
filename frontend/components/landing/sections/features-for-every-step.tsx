...
const Card = ({ Icon, title, description, href }: CardProps) => (
  <Link
    ...
    href={href}
    className="group bg-surface-250 font-sans-landing relative overflow-hidden flex flex-col h-[180px] pl-5 pr-4 py-4 justify-between rounded transition-all duration-300 hover:bg-surface-300"
  >
    <CardHoverGlow />
