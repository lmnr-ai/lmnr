...
// surface-250 panel with the footnote pinned to the bottom.
const AskInSlack = () => (
  <section className="flex flex-col gap-10 items-start w-full">
    ...
    <div className="bg-surface-250 relative flex items-center w-full md:py-[61px] py-[44px] overflow-hidden px-8">
