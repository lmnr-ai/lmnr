...
// Rust logo rendered as inline JSX so `fill="currentColor"` lets the parent
// drive paint via any text-* class. External SVG via <img> is sandboxed and
// can't be restyled from the page.
interface Props {
  className?: string;
  style?: CSSProperties;
}

const RustLogo = ({ className, style }: Props) => (
  <svg
    className={className}
    style={style}
    viewBox="0 0 144 144"
