// TODO: delete once the landing redesign is complete. The new hero lives at
// `./index.tsx`; this snapshot remains importable by `landing/index_old.tsx`.
...
const Hero = ({ className, hasSession }: Props) => (
  <div className={cn("bg-landing-surface-800 flex flex-col w-full h-[calc(100dvh+20px)] items-center", className)}>
    ...
    <div className={cn("flex flex-1 flex-col gap-12 w-full pt-8", "md:pt-36 md:gap-8 md:max-w-[1104px]")}>
