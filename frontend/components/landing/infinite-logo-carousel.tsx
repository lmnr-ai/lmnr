...
import { LogoBrowserUse, LogoRye, LogoRemo, LogoAxionRay } from "@/components/ui/icons";
...
export default function InfiniteLogoCarousel() {
  ...
  return (
    <div className="relative overflow-hidden xl:max-w-[1000px] 2xl:max-w-[1200px] w-full">
      {/* Fade gradients */}
