...
A signal is a definition: a name, a prompt, and a structured output schema. Once defined, it can be produced two ways:

- **Code-emitted events** you're already sending from your application
