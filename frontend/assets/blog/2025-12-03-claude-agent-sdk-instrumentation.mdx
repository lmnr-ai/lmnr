...
With [**Claude Agent SDK**](https://docs.anthropic.com/en/docs/agents-and-tools/claude-code/agent-sdk), you can build various agents including automated PR reviewers, self-healing CI/CD pipelines, research agents, web automations, or practically any task you can describe. Agents can spawn subagents, each with their own tools and context, creating deep execution trees.
...
By solving the process-boundary problem with our Rust proxy, Laminar captures every LLM call, every tool execution, every subagent's trajectory — all nested under your application's trace. It doesn't require you to spin up any additional infrastructure and handles everything in place.
