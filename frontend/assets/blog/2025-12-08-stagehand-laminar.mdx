...
Stagehand gives you access to low-level Playwright APIs on its Page instance while layering in AI-powered features. From targeted actions up to fully autonomous Agents, you choose how much control to keep and how much to delegate.
...
const result = await agent.execute(
  "Find the top story about AI, click into it, and extract the title and top comment"
);
...
- **Synchronized session recordings** - Video of exactly what your automation saw, timestamped to each action
...
[**Start tracing your Stagehand automations →**](https://laminar.sh/)
