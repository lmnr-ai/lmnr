  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-4">
      <div>
        ...
        <div>
          <span>
            This Cookie Policy explains how LMNR AI, Inc. (DBA Laminar) ("<strong>Company</strong>," "
        ...
        <span>
          Cookies set by the website owner (in this case, LMNR AI, Inc. (DBA Laminar)) are called "first-party cookies."
        ...
        <div>
          <span>
            ...
            perform are described in the table below (please note that the specific{" "}
          </span>
          <span>cookies served may vary depending on the specific Online Properties you visit):</span>
          <span>
            <strong>
              <u>
                <br />
              ...
              <table>
                <tbody>
                  <tr>
                    <th>Name: </th>
                    <td>
                      <span>__Secure-better-auth.state</span>
                    </td>
                  </tr>
                  <tr>
                    <th> Purpose:</th>
                  ...
                  <tr>
                    <th> Provider:</th>
                    <td>
                      <span>LMNR AI, Inc. (DBA Laminar)</span>
                    </td>
                  </tr>
                  <tr>
                    <th>Type: </th>
              ...
              <table>
                <tbody>
                  <tr>
                    <th>Name: </th>
                    <td>
                      <span>evaluation-trace-view-width</span>
                    </td>
                  </tr>
                  <tr>
                    <th> Purpose:</th>
                    <td>
                      <span>Store viewing functionality</span>
                    </td>
                  </tr>
                  <tr>
                    <th> Provider:</th>
              ...
              <table>
                <tbody>
                  <tr>
                    <th>Name: </th>
                    <td>
                      <span>traces-trace-view-width</span>
                    </td>
                  </tr>
                  <tr>
                    <th> Purpose:</th>
                    <td>
                      <span>Store view configuration</span>
                    </td>
                  </tr>
                  <tr>
                    <th> Provider:</th>
              ...
              <table>
                <tbody>
                  <tr>
                    <th>Name: </th>
                    <td>
                      <span>__Secure-better-auth.session_token</span>
                    </td>
                  </tr>
                  <tr>
                    <th> Purpose:</th>
        ...
        <span>We may update </span>
        <span>
          this Cookie Policy from time to time in order to reflect, for example, changes to the cookies we use or for
