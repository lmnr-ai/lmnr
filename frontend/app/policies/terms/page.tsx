  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <div>
          <a href="#userdata">
            <span>16. CUSTOMER DATA AND MODEL IMPROVEMENT</span>
          </a>
          <a href="#electronic"></a>
        </div>
        <div>
      ...
      <div>
        <div>
          ...
          <span>
            ...
            informally for at least 30 days before initiating any court proceeding. Such informal negotiations commence
          ...
          <div>
            Any Dispute that is not resolved through informal negotiations shall be resolved exclusively in the state
            and federal courts located in Delaware, as set out in the "GOVERNING LAW" section above, and the Parties
            consent to the personal jurisdiction of those courts. Nothing in this section prevents either Party from
            seeking injunctive or other equitable relief to protect its intellectual property or confidential
          ...
          <div id="userdata">
            <strong>
              <h2>16. CUSTOMER DATA AND MODEL IMPROVEMENT</h2>
            </strong>
          </div>
          <div>
            <strong>
          ...
          <div>
            <span>
              "<strong>Customer Data</strong>" means the data you submit to the Services for processing, including
              traces, spans, and their contents (such as model inputs and outputs, prompts, tool calls, and message
              content), session recordings, evaluation and dataset records, and associated metadata. Customer Data does
              not include your account registration information, billing information, or usage and diagnostic data about
              how you use the Services. As between you and us, you retain all right, title, and interest in and to
              Customer Data. You are responsible for the content of Customer Data and represent that you have all
              rights, consents, and permissions necessary to submit it to the Services and to grant the licenses in this
              section, including with respect to any personal data of your own end users contained in it.
            </span>
          </div>
          <div>
            <strong>
              <h3>License to provide the Services</h3>
            </strong>
          </div>
          <div>
            <span>
              You grant us a worldwide, non-exclusive license to host, store, process, transmit, and display Customer
              Data as necessary to provide, maintain, secure, and support the Services and to comply with law. This
              license is limited to those purposes and ends when the Customer Data is deleted from the Services, except
              as needed to comply with law.
            </span>
          </div>
          <div>
            <strong>
              <h3>Model improvement license and Privacy Mode</h3>
            </strong>
          </div>
          <div>
            <span>
              Each workspace has a <strong>Privacy Mode</strong> setting, which is ON by default. While Privacy Mode is
              on, we do not use that workspace's Customer Data to train or improve machine-learning models.
            </span>
          </div>
          <div>
            <span>
              If a workspace owner turns Privacy Mode off, you grant us a non-exclusive, revocable license to use
              Customer Data from that workspace to train and improve our machine-learning models and Services, subject
              to all of the following commitments:
            </span>
          </div>
          <ul>
            <li>
              <span>
                <strong>Mandatory redaction.</strong> Customer Data is processed through our redaction pipeline,
                designed to remove detected personal information, before any use for training. This applies on the
                training path regardless of your project-level ingestion settings.
              </span>
            </li>
            <li>
              <span>
                <strong>Prospective revocation.</strong> Turning Privacy Mode back on revokes the license and stops any
                new use of that workspace's Customer Data for training from that point forward. Revocation does not
                affect models already trained, which cannot be reversed to remove the influence of previously used data.
              </span>
            </li>
            <li>
              <span>
                <strong>Scope.</strong> This license applies only to Customer Data processed by Laminar-hosted
                deployments of the Services. It does not apply to self-hosted deployments or to data stored on
                customer-controlled data planes, which we do not access for training. See our Data Use page at{" "}
                <a href="/policies/data-use">https://laminar.sh/policies/data-use</a> for a plain-language description
                of how data is used.
              </span>
            </li>
          </ul>
          <div>
            <span>
              If a separate written agreement between you and us (such as an enterprise agreement or data processing
              agreement) addresses the use of Customer Data for model training, that agreement controls over this
              section to the extent of any conflict.
            </span>
          </div>
          <div>
            <strong>
              <h3>Backups and responsibility</h3>
            </strong>
          </div>
          <span>
