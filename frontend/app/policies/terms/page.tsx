 ...
 *
 * §20 (Customer Data and model improvement) was added for LAM-2028 and is the
 * only section drafted against the code-level data inventory. The surrounding
 * sections are inherited template text; known defects in them (notably the §11
 * arbitration forum) are tracked in docs/internal/counsel-handoff.md.
 */
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-4">
      ...
      <div>
        ...
        <div>
          <a href="#customerdata">
            <span>20. CUSTOMER DATA AND MODEL IMPROVEMENT</span>
          </a>
        </div>
      </div>
      <div>
      ...
      <div>
        <div>
          ...
          <div id="customerdata">
            <strong>
              <h2>20. CUSTOMER DATA AND MODEL IMPROVEMENT</h2>
            </strong>
          </div>
          <div>
            <strong>
              <h3>20.1 Customer Data defined</h3>
            </strong>
          </div>
          <span>
            &quot;<strong>Customer Data</strong>&quot; means all data that you, or an end user of your application,
            transmit to or through the Services for processing, together with any derived artefacts we generate from
            that data in the course of providing the Services. It includes traces and spans and their attributes, the
            language model prompts and completions recorded on those spans, tool definitions and tool call records,
            browser session recordings, evaluation runs and their inputs, outputs and scores, datasets and dataset
            records, and labelling queue items. Customer Data does not include (a) data about your account, workspace,
            billing or use of the Services, or (b) feedback and Submissions you give us under the &quot;
            <a href="#ip">INTELLECTUAL PROPERTY RIGHTS</a>&quot; section.
          </span>
          <div>
            <strong>
              <h3>20.2 Ownership; our role</h3>
            </strong>
          </div>
          <span>
          ...
          <div>
            <strong>
              <h3>20.3 Licence for model improvement</h3>
            </strong>
          </div>
          <span>
            Subject to §20.4, you grant us a non-exclusive, worldwide, royalty-free licence to use Customer Data to
            train, fine-tune, evaluate and otherwise improve machine learning models used to provide and improve the
            Services. This licence is granted solely for that purpose and is <strong>revocable</strong>: you may revoke
            it at any time by enabling Privacy Mode, with the effect described in §20.5. This licence does not permit us
            to sell Customer Data, to disclose it other than as described in our Privacy Notice, or to permit any third
            party to train its own models on it.
          </span>
          <div>
            <strong>
              <h3>20.4 Privacy Mode carve-out</h3>
            </strong>
          </div>
          <span>
            Privacy Mode is a workspace setting and is <strong>enabled by default</strong> for every workspace.{" "}
            <strong>
              While Privacy Mode is enabled for a workspace, the licence in §20.3 does not apply to that
              workspace&apos;s Customer Data, and we will not use that Customer Data to train, fine-tune or otherwise
              improve any model, nor include it in any training corpus.
            </strong>{" "}
            The licence in §20.3 therefore takes effect only for a workspace whose owner has affirmatively disabled
            Privacy Mode, and only in respect of that workspace. In addition, and regardless of the Privacy Mode
            setting, the licence in §20.3 never applies to Customer Data held in a self-hosted deployment or in a
            customer-operated data plane.
          </span>
          <div>
            <strong>
              <h3>20.5 Opt-out is prospective only</h3>
            </strong>
          </div>
          <span>
            Enabling Privacy Mode, or otherwise revoking the licence in §20.3, takes effect prospectively. It stops our
            further use of the relevant Customer Data for model improvement from the time it takes effect. IT DOES NOT
            REQUIRE US TO REMOVE CUSTOMER DATA FROM A TRAINING CORPUS IN WHICH IT HAS ALREADY BEEN INCLUDED, AND IT DOES
            NOT REQUIRE US TO REMOVE, REVERSE OR RETRAIN AWAY THE INFLUENCE OF THAT CUSTOMER DATA ON MODEL WEIGHTS
            ALREADY TRAINED, WHICH IS NOT TECHNICALLY FEASIBLE. The same limitation applies to a deletion request
            received after training has occurred. Nothing in this §20.5 limits your rights, or our obligations, in
            respect of deletion of Customer Data from the Services themselves.
          </span>
          <div>
            <strong>
              <h3>20.6 Mandatory redaction on the training path</h3>
            </strong>
          </div>
          <span>
            We will apply automated personal data detection and redaction to Customer Data before it enters any training
            corpus. This commitment applies <strong>whether or not</strong> you have enabled redaction at ingestion for
            the relevant project; ingestion-time redaction is a separate, optional feature and disabling it does not
          ...
          <div>
            <strong>
              <h3>20.7 Inference is not training</h3>
            </strong>
          </div>
          <span>
          ...
          <div>
            <strong>
              <h3>20.8 Relationship to the Data Processing Addendum</h3>
            </strong>
          </div>
          <span>
