  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-4">
      <div>
        ...
        <div>
          <span>
            This Privacy Notice for LMNR AI, Inc. (doing business as Laminar) ("<strong>we</strong>," "
            <strong>us</strong>," or "<strong>our</strong>"{" "}
          </span>
          <span>
            ), describes how and why we might access, collect, store, use, and/or share ("<strong>process</strong>")
            your personal information when you use our services ( "<strong>Services</strong>" ), including when
            you:{" "}
          </span>
        </div>
        <ul>
          <li>
            <span>
              ...
              <a href="https://laminar.sh" target="_blank">
                https://laminar.sh
              </a>
        ...
        <div>
          <ul>
            <li>
              <span>
                Use Laminar. Open-source AI engineering platform offering observability, evaluations, and advanced data
                management
              </span>
            </li>
          </ul>
          ...
          <div>
            <span>
              ...
              still have any questions or concerns, please contact us at founders@lmnr.ai.
            </span>
          </div>
          <div>
            <strong>
          ...
          <div>
            <span>
              <a href="#legalbases">
                <span>
                  3. <span>WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</span>
                </span>
              </a>
            </span>
          </div>
          ...
          <div>
            <a href="#ai">
              <span>6. DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?</span>
            </a>
          </div>
          <div>
            <span>
          ...
          <div>
            <span>
              <a href="#inforetain">
                <span>8. HOW LONG DO WE KEEP YOUR INFORMATION?</span>
              </a>
            </span>
          </div>
          <div>
            <span>
              <a href="#infosafe">
                <span>9. HOW DO WE KEEP YOUR INFORMATION SAFE?</span>
              </a>
            </span>
          </div>
          <div>
            <span>
              <a href="#infominors">
                <span>10. DO WE COLLECT INFORMATION FROM MINORS?</span>
              </a>
            </span>
          </div>
          ...
          <div>
            <span>
              <a href="#DNT">
                <span>12. CONTROLS FOR DO-NOT-TRACK FEATURES </span>
              </a>
            </span>
          </div>
          <div>
            <span>
              <a href="#uslaws">
                <span>13. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span>
              </a>
            </span>
          </div>
          <div>
            <span>
              <a href="#policyupdates">
                <span>14. DO WE MAKE UPDATES TO THIS NOTICE?</span>
              </a>
            </span>
          </div>
          <div>
            <a href="#contact">
              <span>15. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span>
            </a>
          </div>
          <div>
            <a href="#request">
              <span>16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span>
            </a>
          </div>
          <div id="infocollect">
            <span>
          ...
          <div>
            <span>
              ...
              your existing social media account details, like your Facebook, X, or other social media account. If you
          ...
          <div>
            <span>
              ...
              <a href="https://laminar.sh/policies/cookies" target="_blank">
                https://laminar.sh/policies/cookies
              </a>{" "}
              .{" "}
            </span>
          </div>
          ...
          <ul>
            <li>
              <span>
                ...
                can be either precise or imprecise. How much information we collect depends on the type and settings of
          ...
          <div id="infouse">
            ...
            <span>
              ...
              <em>
                ...
                following purposes listed below. We may also process your information for other purposes only with your
          ...
          <ul>
            <li>
              <span> Analyze how our Services are used so we can improve them to engage and retain users </span>
            </li>
          </ul>
          <ul>
            <li>
              <span>Diagnose problems and/or prevent fraudulent activities </span>
            </li>
          </ul>
          <ul>
            <li>
              <span>Understand how our users use our products and services so we can improve user experience </span>
            </li>
          </ul>
          <ul>
            <li>
          ...
          <div>
            <span>
              <strong>
                <span>Use of AI Technologies</span>
              </strong>
            </span>
          </div>
          <div>
            <span>
              ...
              OpenAI , Anthropic and Google Cloud AI . As outlined in this Privacy Notice, your input, output, and
              personal information will be shared with and processed by these AI Service Providers to enable your use of
          ...
          <div>
            <span>
              <strong>
                <span>How We Process Your Data Using AI</span>
              </strong>
            </span>
          </div>
          <span>
          ...
          <div id="infominors">
            ...
            <span>
              ...
              <em>
                {" "}
                We do not knowingly collect data from or market to children under 18 years of age or the equivalent age
                as specified by law in your jurisdiction .{" "}
              </em>
            </span>
          </div>
          <div>
            <span>
              ...
              18 years of age or the equivalent age as specified by law in your jurisdiction has been collected, we will
              deactivate the account and take reasonable measures to promptly delete such data from our records. If you
              become aware of any data we may have collected from children under age 18 or the equivalent age as
              specified by law in your jurisdiction , please contact us at <span> robert@lmnr.ai </span>.{" "}
            </span>
          </div>
          ...
          <div>
            <span>
              ...
              review. In certain circumstances, you may also have the right to object to the processing of your personal
          ...
          <div>
            <span>
              ...
              <span>
                <a href="https://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm" target="_blank">
          ...
          <div>
            ...
            <span>
              {" "}
              " below. You will then be removed from the marketing lists. However, we may still communicate with you —
          ...
          <span>
            If you have questions or comments about your privacy rights, you may email us at founders@lmnr.ai .
          </span>
          <div id="DNT">
            <span>
              <strong>
          ...
          <div id="uslaws">
            ...
            <span>
              ...
              <em>
                If you are a resident of California or Delaware , you may have the right to request access to and
          ...
          <div>
            ...
            <span>Learn more about the sources of personal information we collect in " </span>
            <span>
              <span>
                <a href="#infocollect">
                  <span>WHAT INFORMATION DO WE COLLECT?</span>
          ...
          <ul>
            <li>
              <span>
                ...
                permitted by applicable law, including the privacy law in California and Delaware ){" "}
              </span>
            </li>
          </ul>
          <ul>
          ...
          <div>
            ...
            <span> by emailing us at founders@lmnr.ai , </span>
          ...
          <div>
            ...
            <span>
              ...
              <span>
                ...
                may appeal our decision by emailing us at founders@lmnr.ai . We will inform you in writing of any action
          ...
          <div id="request">
            ...
            <span>
              ...
              by applicable law. To request to review, update, or delete your personal information, please{" "}
            </span>
            <span>
              contact us at:{" "}
              <a href="mailto:founders@lmnr.ai" target="_blank">
                founders@lmnr.ai
              </a>
            </span>
            <span>.</span>
